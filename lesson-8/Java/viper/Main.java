...
// Класс ConsoleTaskListView реализует интерфейс TaskListView для консольного
// вывода
...
// Класс InMemoryTaskRepository реализует интерфейс TaskRepository и
// предоставляет список задач в памяти
...
// Компонент Presenter
// Класс TaskListPresenter связывает View и Interactor, обрабатывает данные и
// события
...
public class Main {
    public static void main(String[] args) {
        ...
        //Context context = new TaskListRouter(context);
